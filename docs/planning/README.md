...
1. `CURRENT_RUNTIME_CHECKPOINT_2026-08-05.md`
2. `CURRENT_CONFIRMED_DECISIONS.md`
3. `../validation/GR_TEST_032_EXECUTION_RUNBOOK.md`
4. `../validation/GR_TEST_032_MODERATOR_SCRIPT.md`
5. `../validation/GR_TEST_032_DEVICE_PREFLIGHT.md`
6. `GR_TEST_032_EXECUTION_READY_GATE_2026-08-06.md`
7. `sync/GR-SYNC-20260806-01-GR-TEST-032-EXECUTION-READY.md`

이전 `STAGE2_HARNESS_AUTOMATED_PASS_HUMAN_NOT_RUN`은 자동 증거다. 현재 사람 결과는 `HUMAN_EXECUTION_NOT_RUN`; 준비 완료는 `NO_HUMAN_PASS_CLAIM`이다.
