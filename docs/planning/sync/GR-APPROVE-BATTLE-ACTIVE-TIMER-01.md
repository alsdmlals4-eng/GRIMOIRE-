...
| 승인 책임 원본 | `docs/planning/BATTLE_ACTIVE_TIMER_INSTANT_CAST_PHASES_01_APPROVAL_2026-08-01.md` | `eee96e1c58dbb24eed80488c875da359a3102fe4` |
| 상태 데이터 | `docs/planning/BATTLE_ACTIVE_TIMER_INSTANT_CAST_PHASES_01_STATE.json` | `ebcfd8a011f2ff434e844fa30398862b167b9cca` |
...
재조회 결과 Decision ID, 승인 상태, 일반/보스 페이즈 구분, 마나 부족 복구와 미검증 경계가 일치한다.
...
- 작성 중 적 타이머가 계속 진행되는가, 감속되는가, 정지하는가.
- 적 공격 간격과 난이도별 변화.
- 피해·방어·상태·승리·패배 규칙.
- 보스 페이즈 전환 시 정확한 유지·회복·연출.
