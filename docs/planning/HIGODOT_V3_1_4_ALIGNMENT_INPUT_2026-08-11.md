...
project_main_at_handoff_start: cdbd1966732b8e352fa09d141e185f7d6de5c89f
repaired_base_toolchain_sync: GR-SYNC-20260811-18-GODOT-TOOLCHAIN-DOWNLOAD-RESILIENCE
...
This refreshed copy is based on repaired project `main` `cdbd1966732b8e352fa09d141e185f7d6de5c89f`, where the Godot 4.7.1 toolchain export-template download integrity fix from Sync18 is already merged. No Task 8 product assumption changed, so the Sync17 research receipt is reused.
