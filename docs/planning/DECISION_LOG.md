...
| GM-WORLD-01 | 세계관 기본 틀 | 마법학교+현장실습+성장 모험 | `DIRECTION_CONFIRMED` | 학교 허브와 외부 모험을 연결 |
| GM-WORLD-02 | 비밀학과 중심 서사 | 비밀학과는 제외 | `CONFIRMED` | 학교 음모보다 학습·모험·발견에 집중 |
| GM-WORLD-03 | 콘텐츠 확장 방식 | 회로의 활용으로 자유롭게 추가 | `DIRECTION_CONFIRMED` | 기존 회로의 응용과 현장 상황으로 콘텐츠 확장 |
...
- 마력 교란 30% 감속은 기획 기본값이며 실제 수치는 PoC에서 조정할 수 있다.
...
- 학교는 수업·교류·준비·숙련의 생활 허브다.
- 실제 전투·탐험·주문 발견은 현장실습에서 주로 발생한다.
- 비밀학과와 학교 음모를 세계관의 필수 중심축으로 사용하지 않는다.
- 기존 회로도 목적·대상·환경·연결 방식에 따라 새로운 활용을 만들 수 있다.
- 현장 문제는 처치 외에도 구조·봉인·복구·조사·환경 조작으로 해결할 수 있다.
- 신규 콘텐츠는 기존 회로의 활용 범위를 넓히는 방식으로 확장할 수 있다.
...
| 후보 ID | 질문 | 상태 |
|---|---|---|
| GM-WORLD-04 | 학교는 단일 명문학교·학교 도시·여러 학교 중 하나 중 어떤 구조인가 | `UNRESOLVED` |
| GM-WORLD-05 | 주인공은 신입생·편입생·견습 연구생 중 무엇인가 | `UNRESOLVED` |
| GM-WORLD-06 | 성장은 학년제·자격 등급제·혼합형 중 무엇인가 | `UNRESOLVED` |
| GM-WORLD-07 | 현장실습은 학교 배정·학생 선택·혼합형 중 무엇인가 | `UNRESOLVED` |
| GM-WORLD-08 | 세계의 장기 갈등은 무엇인가 | `UNRESOLVED` |
