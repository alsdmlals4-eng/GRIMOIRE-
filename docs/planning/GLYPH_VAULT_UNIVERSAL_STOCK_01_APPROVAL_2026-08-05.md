...
implementation_plan: docs/superpowers/plans/2026-08-05-glyph-resource-foundation-poc-implementation-plan.md
...
natural_charge_progress: UNIVERSAL_STOCK_SINGLE_CHARGE_PROGRESS
...
Vocabulary의 의미 범위와 Slice 우선 6종은 `GM-GLYPH-VOCABULARY-V1-01`에서 별도로 승인됐다.
...
- Vocabulary 승인: `docs/planning/GLYPH_VOCABULARY_V1_01_APPROVAL_2026-08-05.md`.
...
Spec 검토는 완료됐지만 PR #61은 Draft·미병합 상태다. 승인 Batch는 `3/10`, `merge_required: false`, `merge_authorized: false`다. 최신 exact-head CI, Sheet Readback, 적대적 검토와 별도 병합 승인이 없으면 main에 병합하지 않는다.
