...
Current first-session story blueprint owner: `docs/superpowers/specs/2026-09-01-story-arc-blueprint-design.md`. Its [human PDF derived view](../output/pdf/GRIMOIRE_STORY_ARC_BLUEPRINT_2026-09-02.pdf) is a **32-page detailed review edition** of that Markdown source, exposing the current screen states, inputs, system boundaries, assets, runtime anchors, and evidence ceilings. The first practicum reuses tracked `assets/art/backgrounds/greenhouse/bg_greenhouse_field_base.webp` at `StoryEventRoot/EnvironmentBackground` as a live texture under a readability veil; it contains no baked UI. Source/PDF hashes and all-page render evidence are in `output/pdf/GRIMOIRE_STORY_ARC_BLUEPRINT_2026-09-02.manifest.json`. It does not supersede the Markdown owner or upgrade Human/Device/Accessibility/Performance/Export evidence.
