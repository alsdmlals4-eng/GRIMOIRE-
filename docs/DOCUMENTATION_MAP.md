...
Current Frostbloom W6 choice owner: `docs/planning/FROSTBLOOM_W6_PRESERVATION_PRIORITY_01_APPROVAL_2026-08-28.md`. Its planning-only visual brief is `docs/planning/visual/FROSTBLOOM_W6_PRESERVATION_PRIORITY_VISUAL_BRIEF_2026-08-28.md`; it requires a subsequent explicit image-generation approval.
