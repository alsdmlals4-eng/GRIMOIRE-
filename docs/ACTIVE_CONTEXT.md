...
조사 → 의미 선택 → 3×3 회로 → Preview → Commit → 변화·대가 → 복기
```
...
- PR #63 Recognition 6종 자동화·정본 PASS, Draft·미병합.
- PR #65 Stage 2 Low-fi Harness 자동화 PASS, Draft·미병합.
...
- Recognition/Core-loop/Moderator Event Stream 분리.
- 익명 참가자 ID만 허용하고 원시 PII를 금지.
- 자동 해법·Best Glyph·확률 표시는 금지.
