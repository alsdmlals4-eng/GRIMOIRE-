...
GUT formal adoption, repo-wide Actions full-SHA, HiGodot vendor integrity, Hera exact CLI/addon pair는 닫혔다. PR #82 Task 2는 visual/audio와 Windows/Android product validation이 남아 있어 아직 시작하지 않는다.
