...
| --- | --- | --- |
| Godot headless suite | PASS | 34 suites, 1,434 assertions, 0 failures |
...
| --- | --- | --- |
| `FirstClassRoot` | environment layer, direct glyph input/recognition/acceptance, locked continuation button | `artifacts/runtime/2026-09-01-first-class-glyph-gate-1280x720.png` |
