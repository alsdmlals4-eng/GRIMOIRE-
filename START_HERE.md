...
| Base 정본 | `v9.4.3` |
| Core Alignment Decision | `GM-CORE-SYSTEM-ALIGNMENT-01 / MERGED_AND_FINALIZED` |
| Decision PR | `#47 / merge 1f814a16f3a523379a8ffe4b2a87a02d0c97e287` |
| Finalization PR | `#48 / merge 7f4213da6d0fde6125011d0a76ce677c7ea83166` |
| 현재 main | `7f4213da6d0fde6125011d0a76ce677c7ea83166` |
| Main Sync | `GR-SYNC-20260802-24 / SHEET_READBACK_PASS` |
...
4. `docs/planning/CORE_SYSTEM_ALIGNMENT_01_SUMMON_CLARIFICATION_ADVERSARIAL_REVIEW_2026-08-02.md`.
5. `docs/planning/GRIMOIRE_CORE_SYSTEM_ALIGNMENT_AUDIT_2026-08-02.md`.
...
10. 과거 `ACTIVE_CONTEXT`, `DEVELOPMENT_GATES`, `DESIGN_DOCUMENT_REGISTRY`는 Core Alignment 정본과 충돌하지 않는 범위에서만 사용하며 다음 정합성 작업에서 직접 교정한다.
...
- 저장 단위·용량·비용·충전량·보존 범위는 `GM-STOCK-SYSTEM-01`에서 결정.
...
- 기타 소환수는 플레이어의 `[소환]` 주문 Commit 뒤 활성.
...
```text
Core Alignment readback 상태 문서 최종화
