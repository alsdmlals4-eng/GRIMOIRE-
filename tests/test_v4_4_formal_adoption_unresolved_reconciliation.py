...
class V44FormalAdoptionUnresolvedReconciliationTests(unittest.TestCase):
    def test_current_unresolved_file_uses_v4_4_and_closes_resolved_gut_blockers(self) -> None:
        ...
        self.assertIn("formal_adoption_scope: READY_IF_CURRENT_HEAD_CHECKS_PASS", text)
        for stale in (
