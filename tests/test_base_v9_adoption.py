...
class BaseV942AdoptionTests(unittest.TestCase):
    def test_canonical_adapter_pins_v942_and_preserves_project_boundaries(self) -> None:
        ...
        self.assertEqual("PC", adapter["project"]["follow_up_platform"])
    ...
    def test_generated_views_preserve_platform_and_evidence_ceiling(self) -> None:
        ...
        self.assertEqual("v9.4.2", base_view["base"]["release_line"])
