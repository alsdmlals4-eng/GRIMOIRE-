...
class ContractTests(unittest.TestCase):
    ...
    def test_project_profile(self):
        ...
        for token in ("LOWEST_VIABLE_RATING", "AVOID_ADULTS_ONLY", "Mobile", "Google_Play", "PC_LATER", "Steam", "STOVE", "ALL_OR_12_CANDIDATE", "RELEASE_BLOCKED_UNVERIFIED", "PLATFORM_SUBMISSION_NOT_RUN", "LEGAL_REVIEW_NOT_PERFORMED"):
    ...
    def test_release_pack_and_agents_routing(self):
        ...
        for token in ("build_store_questionnaire_consistency", "asset_rights_coverage", "RELEASE_BLOCKED_UNVERIFIED", "Google_Play", "Steam", "STOVE"):
